...
function Dashboard({ card }) {
    ...
    //    const data = cardData.map((value) => <CardData value={value} key={value.id}/>)
    //   const cardList = card.map((value) => <CardData value={value} key={value.id} />)
    ...
    return (
        ...
        <div className="container-fluid">
            ...
            <div className="row">
                {card && card.map((value) =>
                    <CardData value={value} key={value.id} />
                )}
