...
function Topbar() {
    ...
    const card = [{
        ...
        fontColor : "text-xs font-weight-bold text-primary text-uppercase mb-1",
    ...
    },
    {
        ...
        fontColor : "text-xs font-weight-bold text-success text-uppercase mb-1",
    ...
    },
    {
        ...
        fontColor : "text-xs font-weight-bold text-info text-uppercase mb-1",
        text: "TASKS",
        price: "50%",
    ...
    },
    {
        ...
        fontColor : "text-xs font-weight-bold text-warning text-uppercase mb-1",
